...
def calibrate(dirpath, prefix, image_format, square_size, width=9, height=6):
    ...
    # Check if we found any chessboards at all
    if not found:
        print("No chessboard corners were detected in any of the images!")
        print(f"Found {len(images)} images in {dirpath}/{prefix}*.{image_format}")
        return [None, None, None, None, None]
    
    # Now we can use gray, knowing it has been defined
...
if __name__ == '__main__':
    ...
    if ret is None:
        print("Calibration failed. Please check your images and parameters.")
    else:
